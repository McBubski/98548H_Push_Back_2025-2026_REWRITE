...
void Skills(void) {
    ...
    std::cout << "Skills Code Estimate" << std::endl;
...
*/
    ...
    second_long_goal_path.waypoints[12].onReach = []() {
        matchloader.set(false);
    };
    ...
    FollowPath(second_long_goal_scoring_path, reverse, 18.0);
